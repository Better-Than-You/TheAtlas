  ...
  start: async (
    ...
    switch (inputCMD) {
      ...
      case "setmod":
        ...
        if (!userId) return m.reply("Please mention a valid user to add Mod!");
      ...
      case "removemod":
        ...
        if (!userId) return m.reply("Please mention a valid user to remove from Mods!");
      ...
      case "banlist":
   try {
      var banlist = await userData.find({ ban: true });
      var banlistString = "";
    ...
    break;
      ...
      case "setchar":
        ...
        const botLogos = [
          "https://graph.org/file/3f993abddf38a41d20bc0.jpg",
          "https://graph.org/file/37cadd49136ef984b7932.jpg",
          "https://graph.org/file/dc0569cb8c6eb4ad4e712.jpg",
          "https://graph.org/file/6d75ea2edd0543628a469.jpg",
